...
function Message({ message, onViewProfile, onReport, onCopyLink, currentUsername, mentionUsers, chatFramesEnabled, linked, copied }) {
...
export default function ChatRoom({ room='lobby', currentUsername, mentionUsers=[], chatFramesEnabled=true, targetMessageId=null, messages, status, onSend, onViewProfile, onReport, onSlowMode, pingsEnabled, onEnablePings, slowModeSeconds=0, lastSentAt, serverRemaining=0, isModerator=false }) {

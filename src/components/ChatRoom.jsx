...
function Message({ message, onViewProfile, onReport, currentUsername, mentionUsers, chatFramesEnabled }) {
...
export default function ChatRoom({ room='lobby', currentUsername, mentionUsers=[], chatFramesEnabled=true, messages, status, onSend, onViewProfile, onReport, onSlowMode, pingsEnabled, onEnablePings, slowModeSeconds=0, lastSentAt, serverRemaining=0, isModerator=false }) {

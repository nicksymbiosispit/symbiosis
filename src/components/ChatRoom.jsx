...
export default function ChatRoom({ messages, status, onSend, onViewProfile, onReport, slowModeSeconds=0, lastSentAt, isModerator=false }) {
  ...
  const remaining = isModerator || !lastSentAt ? 0 : Math.max(0, Math.ceil((lastSentAt + slowModeSeconds*1000 - now)/1000));

...
export default function ChatRoom({ room='lobby', userId, currentUsername, mentionUsers=[], availableRooms=[], chatFramesEnabled=true, targetMessageId=null, messages, status, onSend, onDelete, canDeleteAny=false, onViewProfile, onReport, onJumpMessage, onJumpRoom, onJumpBulletin, onSlowMode, pingsEnabled, onEnablePings, slowModeSeconds=0, mediaMode='allowed', lastSentAt, serverRemaining=0, isModerator=false }) {

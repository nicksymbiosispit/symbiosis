...
function Message({ message, onViewProfile, onReport }) {
...
export default function ChatRoom({ messages, status, onSend, onViewProfile, onReport, onSlowMode, slowModeSeconds=0, lastSentAt, serverRemaining=0, isModerator=false }) {
  ...
  </div><div className="ad-strip"><span className="ad-star">✮</span><strong>YOU ARE CURRENTLY ONLINE IN SYMBIOSIS</strong><span>GETCHA PULL.</span><span className="ad-sparkle">⋆༺𓆩☠︎︎𓆪༻⋆</span></div>
  </section>;
}

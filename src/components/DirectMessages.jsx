...
export default function DirectMessages({ user, people, requests, friendsApi, initialPerson, onViewProfile, chatFramesEnabled=true, isOnline=()=>false }) {
